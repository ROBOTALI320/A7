...
const categories = [
    ...
    {
        title: '🛠️ ئامێرە زانیارییەکان',
        tools: [
            { name: 'Google Translate', desc: 'وەرگێڕی فەرمی بۆ زانیارییەکان', url: 'https://translate.google.com' },
            { name: 'DeepL Translator', desc: 'وەرگێڕی زانیاری بەرز بۆ زانیارییەکان', url: 'https://www.deepl.com/translator' },
            { name: 'Microsoft Translator', desc: 'وەرگێڕی زانیاری بەرز بۆ زانیارییەکان', url: 'https://www.bing.com/translator' },
            { name: 'Reverso', desc: 'وەرگێڕی زانیاری بەرز بۆ زانیارییەکان', url: 'https://www.reverso.net' },
            { name: 'Babylon Translator', desc: 'وەرگێڕی زانیاری بەرز بۆ زانیارییەکان', url: 'https://www.babylon-software.com' },
            { name: 'LingvaNex', desc: 'وەرگێڕی زانیاری بەرز بۆ زانیارییەکان', url: 'https://lingvanex.com' },
            { name: 'iTranslate', desc: 'وەرگێڕی زانیاری بەرز بۆ زانیارییەکان', url: 'https://www.itranslate.com' },
            { name: 'SayHi', desc: 'وەرگێڕی زانیاری بەرز بۆ زانیارییەکان', url: 'https://www.sayhi.com' },
            { name: 'TextRanch', desc: 'وەرگێڕی زانیاری بەرز بۆ زانیارییەکان', url: 'https://textranch.com' },
            { name: 'GrammarCheck', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://www.grammarcheck.net' },
            { name: 'Plagiarism Checker', desc: 'چاکسازی بۆ نوسین و زانیارییەکان', url: 'https://www.plagiarismchecker.com' },
            { name: 'Small SEO Tools', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://smallseotools.com' },
            { name: 'Duplichecker', desc: 'چاکسازی بۆ نوسین و زانیارییەکان', url: 'https://www.duplichecker.com' },
            { name: 'Search Engine Reports', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://searchenginereports.com' },
            { name: 'PaperRater', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://www.paperrater.com' },
            { name: 'Slick Write', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://www.slickwrite.com' },
            { name: 'ProWritingAid', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://prowritingaid.com' },
            { name: 'Hemingway Editor', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'http://www.hemingwayapp.com' },
            { name: 'Readable', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://readable.com' },
            { name: 'WordCounter', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://wordcounter.net' },
            { name: 'Character Count Tool', desc: 'چاکسازی و ڕوونکردنەوەی نووسین', url: 'https://charactercounttool.com' },
            { name: 'Online Stopwatch', desc: 'ئامێری کاتژمێر بۆ پەیوەندیدانی ماوەی پێشوو', url: 'https://www.online-stopwatch.com' },
            { name: 'Online Timer', desc: 'ئامێری کاتژمێر بۆ پەیوەندیدانی ماوەی پێشوو', url: 'https://www.online-timer.com' },
            { name: 'Countdown Timer', desc: 'ئامێری کاتژمێر بۆ پەیوەندیدانی ماوەی پێشوو', url: 'https://www.countdown.online' },
            { name: 'Online Alarm Clock', desc: 'ئامێری کاتژمێر بۆ پەیوەندیدانی ماوەی پێشوو', url: 'https://www.onlinealarmkur.com' },
            { name: 'Pacer App', desc: 'ئامێری کاتژمێر بۆ پەیوەندیدانی ماوەی پێشوو', url: 'https://www.pacerapp.com' },
            { name: 'My Study Life', desc: 'بەرزبوونی زانیاری بەرز بۆ فەرمی نیشانی خوێندنگەھ', url: 'https://www.mystudylife.com' },
            { name: 'Google Keep', desc: 'بەرزبوونی زانیاری بەرز بۆ نوسین', url: 'https://keep.google.com' },
            { name: 'Microsoft To Do', desc: 'بەرزبوونی زانیاری بەرز بۆ نوسین', url: 'https://todo.microsoft.com' },
            { name: 'Trello', desc: 'بەرزبوونی زانیاری بەرز بۆ نوسین', url: 'https://trello.com' },
            { name: 'Asana', desc: 'بەرزبوونی زانیاری بەرز بۆ نوسین', url: 'https://asana.com' },
